...
int main(){
    ...
    login: //Define o ponto de início do Login de usuário
    	...
    	do{
    		dif=0;
    		if(tentativa>0){
    			gotoxy(45,18); printf("Campo não pode ser vazio!");
			}
    		gotoxy(44,12); printf("                             ");
    		gotoxy(44,12); gets(nome);
    		if(strlen(nome)==0)
    			dif=1;
    		tentativa++;
		}while(dif==1);
    ...
    do{
        ...
        switch (opcao){
            ...
            case 7: //Créditos
            	system("cls");
            	system("color B0");
            	printf("Programa desenvolvido por: \nKaio Henrique A. D. de Paulo e\n");
            	printf("Nícolas Mellilo Alves\n");
            	printf("\nDisiciplina: \nAlgoritmos II.\n");
            	printf("\nProfessora: \nAndrea Vianna.\n");
            	printf("\nDescrição: \nO programa tem como objetivo aplicar os conhecimentos\n");
            	printf("em manipulação de arquivos binários. Para tal, foi escolhido o tema\n");
            	printf("Processadores. Além disso, foram implementados comandos simples do CMD!\n");
